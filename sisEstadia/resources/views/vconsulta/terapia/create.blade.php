...
@section('contenido')
	...
	<div class="row">		
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<h1><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;&nbsp;&nbsp;Nueva terapia</h1>
			<p></p>
		@if (count($errors)>0)
...
{!!Form::open(array('url'=>'vconsulta/terapia','method'=>'POST','autocomplete'=>'off','files'=>'true'))!!}
	{{Form::token()}}
		<!--NOMBRE COMPLETO-->	
		<div class="row">
		...
		<div class="row" align="center">
    		...
    		<div class="form-group col-lg-2 col-md-3 col-sm-2 col-xs-6">
				<div class="form-group">
    				...
    				<select class="combobox form-control" value="{{old('estadoTerapia')}}"name="estadoTerapia">
    					<option >----------</option>
			...
			<div class="col-lg-8 col-md-4 col-sm-4 col-xs-4" >
				<div class="form-group">
					<TEXTAREA
						...
						class="form-control"
						placeholder="Escribir Comentarios para terapia...">{{old('comenTerapia')}}</TEXTAREA>
				</div>
			</div>			
		</div>
